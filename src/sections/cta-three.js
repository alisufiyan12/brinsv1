...
const data = {
  subTitle: 'Some Statistics',
  title: 'Return on Investment for clients',
  //description: "Get your tests delivered at let home collect sample \n from the victory of the managments that supplies \n best design system guidelines ever. Get your tests \n delivered at let home collect sample.",
  description: "Some clients results our team has generated over the \n years including the total ad spent along with the return on investments \n with the lowest cost per purchase to \n showcase why we are the best in the industry. ",
  btnName: 'Get Started',
...
const styles = {
  ctaThree: {
    paddingTop: [0, null, null, null, 50, 40],
    paddingBottom: [60, null, null, null, 100, 60],
    row: {
      display: 'flex',
      flexWrap: 'wrap',
